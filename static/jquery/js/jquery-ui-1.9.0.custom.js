...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		...
		monthNamesShort: ['Jan', 'Fev', 'Mar', 'Abr', 'Maio', 'Jun', 'Jul', 'Ago', 'Set', 'Out', 'Nov', 'Dec'], // For formatting
		...
		dayNamesMin: ['Do','Sg','Tr','Qa','Qi','Sx','Sa'], // Column headings for days starting at Sunday
